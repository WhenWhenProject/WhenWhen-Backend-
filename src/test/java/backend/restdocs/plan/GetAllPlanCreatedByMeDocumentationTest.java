...
public class GetAllPlanCreatedByMeDocumentationTest extends ApiDocumentationTest {

    @Test
    void getAllPlanCreatedByMe() throws Exception {
        // given
        ...
        given(planService.getAllPlanCreatedByMe(any()))
        ...
        result
                .andDo(print())
                .andDo(document("api-plan-host-all",
                        getDocumentRequest(),
                        getDocumentResponse(),
                        requestHeaders(
